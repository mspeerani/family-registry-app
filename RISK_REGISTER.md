...
| R-017 | Restore endpoint is destructive | High | Medium | Document restore risk; keep backup/restore tested; add authentication/confirmation before real production use | Open |
